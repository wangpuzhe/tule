    ...
    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
        <div class="widget am-cf">
            <div class="widget-head am-cf">
                <div class="widget-title  am-cf">空房</div>
            </div>
            <div class="widget-body  am-fr">
                        ...
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-sm">
                                <button type="button" class="am-btn am-btn-default am-btn-success"
                                        onClick="openModal()"><span class="am-icon-plus"></span> 预定
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                    <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                        <input type="text" queryTableId="kxTable" class="enterQuery am-form-field " id="keywordsInput"  placeholder="请输入房间号或房间名称">
                ...
                <div class="am-u-sm-12">
                    ...
                    <table width="100%" class="table table-bordered table-striped table-hover " id="kxTable">
                        <thead>
                        <tr>
               ...
               <%-- <p>Modal body text goes here.</p>--%>
                <form data-am-validator id="loginForm">
                   ...
                   <div class="form-row">
                       <div class="form-group col-md-6">
                           <label>入住时间: </label>
                           <input id="kssj" class="am-form-field"  placeholder="入住时间" type="text" required />
                       </div>
                       <div class="form-group col-md-6">
                           <label>退房时间: </label>
                           <input id="jssj" class="am-form-field" onchange="jisuan()" placeholder="退房时间" type="text" required />
                       </div>
                   </div>
                   ...
                   <div class="form-row">
                       ...
                       <div class="form-group col-md-6">
                           ...
                           <input type="text" class="form-control" id="jbr" required >
                       </div>
                   </div>
                   <div class="form-row">
...
<script src="${ctx}/js/room/free.js"></script>
